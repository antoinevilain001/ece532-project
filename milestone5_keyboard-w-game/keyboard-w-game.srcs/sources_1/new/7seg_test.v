...
module seven_seg_test(
	...
	always @(count[1], count[0], x_decimal, y_decimal, RST) begin
	   if (RST == 1'b1) begin
	       ...
	       case (count)
	           3'b000: data_mux <= in_num[3:0];
	           3'b001: data_mux <= in_num[7:4];
	           3'b010: data_mux <= in_num[11:8];
	           3'b011: data_mux <= in_num[15:12];
	           3'b100: data_mux <= in_num[19:16];
	           3'b101: data_mux <= in_num[23:20];
	           3'b110: data_mux <= in_num[27:24];
	           3'b111: data_mux <= in_num[31:28];
	       endcase
	   end
	end
