...
proc create_root_design { parentCell } {
  ...
  set collision [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 collision ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports collision] [get_bd_intf_pins axi_gpio_0/GPIO2]
