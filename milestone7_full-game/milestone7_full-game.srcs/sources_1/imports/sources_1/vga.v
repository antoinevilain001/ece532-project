...
module vga_bw#(
    ...
    input [9:0] paddle2_x,
    input [9:0] paddle2_y,
    input [9:0] paddle1_height,
    input [9:0] paddle2_height,
    input [9:0] powerup_paddle_x,
    ...
    // define paddle size powerup display, hard coded for size 7, looks like + in box
    wire powerup_paddle = (x == powerup_paddle_x) && (y >= powerup_paddle_y) && (y <= powerup_paddle_y + 6) ||
                          (y == powerup_paddle_y) && (x >= powerup_paddle_x) && (x <= powerup_paddle_x + 6) || 
                          (x == powerup_paddle_x + 6) && (y >= powerup_paddle_y) && (y <= powerup_paddle_y + 6) ||
                          (y == powerup_paddle_y + 6) && (x >= powerup_paddle_x) && (x <= powerup_paddle_x + 6) ||
                          (x == powerup_paddle_x + 3) && (y >= powerup_paddle_y + 2) && (y <= powerup_paddle_y + 4) ||
                          (y == powerup_paddle_y + 3) && (x >= powerup_paddle_x + 2) && (x <= powerup_paddle_x + 4);
